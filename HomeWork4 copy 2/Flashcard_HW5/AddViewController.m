...
- (IBAction)keyboardDone:(id)sender {
    [self.qTF resignFirstResponder];
}

- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    if ([textField isEqual:self.qTF]){
        [self.ansTF becomeFirstResponder];
    }
    else if([textField isEqual:self.ansTF]) {
...
- (IBAction)saveButtonTouched:(id)sender {
    ...
    self.addBlock(self.qTF.text, self.ansTF.text);  
    // }
