...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [flashcard question];  // check
    cell.detailTextLabel.text =[ flashcard question]; //check
    return cell;
}
    ...
    if ([segue.identifier isEqualToString:@"addFlashcardSegue"])
    {
        ...
        avc.addBlock = ^(NSString* question, NSString* answer)
        {
            if(question !=nil && answer != nil)
            {
                ...
                //studentID, firstName and lastName is the same we called in addBlock
